...
<script type="text/javascript">
    ...
    var questionno = 1; // Changed to integer
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                if (xmlhttp.responseText == "over") {
                    window.location = "detailed_results.php";
                } else {
    ...
    function save_answer(questionno) {
        var answer = document.getElementById("open_answer").value;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        ...
        xmlhttp.open("GET", "forajax/save_answer_in_session.php?questionno=" + questionno + "&value1=" + answer, true);
        xmlhttp.send(null);
    }
